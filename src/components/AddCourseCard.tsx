...
export function AddCourseCard({
  ...
  return (
    <label
      className={cn(
        "flex items-center gap-3 w-[336px] md:w-[432px] lg:w-[528px] min-h-[54px] px-3 py-2 rounded-sm bg-surface border border-line-subtle cursor-pointer transition-colors",
