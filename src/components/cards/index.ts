...
export type { LiveClassCardProps } from "./LiveClassCard";

export { LiveExamCard } from "./LiveExamCard";
export type { LiveExamCardProps } from "./LiveExamCard";
...
export type { CourseContentCardProps } from "./CourseContentCard";
