...
const sideClasses = {
  left:   "left-0 top-0 h-full w-[280px] md:w-[360px] animate-[slide-right_200ms_ease-out]",
  right:  "right-0 top-0 h-full w-[280px] md:w-[360px] animate-[slide-left_200ms_ease-out]",
